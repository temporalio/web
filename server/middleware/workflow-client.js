...
function WorkflowClient() {
  ...
  const options = {
    ...
    includeDirs: [
      `${dir}/temporal-api/`,
      `${dir}/temporal-api/temporal/api/common/v1`,
      `${dir}/temporal-api/temporal/api/decision/v1`,
      `${dir}/temporal-api/temporal/api/enums/v1`,
      `${dir}/temporal-api/temporal/api/errordetails/v1`,
      `${dir}/temporal-api/temporal/api/execution/v1`,
      `${dir}/temporal-api/temporal/api/failure/v1`,
      `${dir}/temporal-api/temporal/api/filter/v1`,
      `${dir}/temporal-api/temporal/api/history/v1`,
      `${dir}/temporal-api/temporal/api/namespace/v1`,
      `${dir}/temporal-api/temporal/api/query/v1`,
      `${dir}/temporal-api/temporal/api/replication/v1`,
      `${dir}/temporal-api/temporal/api/taskqueue/v1`,
      `${dir}/temporal-api/temporal/api/version/v1`,
      `${dir}/temporal-api/temporal/api/workflow/v1`,
      `${dir}/temporal-api/temporal/api/workflowservice/v1`,
    ],
  };
